import os
KARLSEND_WRPC_URL = os.getenv("KARLSEND_WRPC_URL")
...
SOMPI_PER_KLS = 100_000_000
MAINNET_MAX_SUPPLY_KLS = 28_704_035_605
DEFAULT_MAX_SUPPLY_KLS = 29_000_000_000
...
match NETWORK_TYPE:
    case "mainnet":
        ...
        max_supply = MAINNET_MAX_SUPPLY_KLS
        crescendo_bs = MAINNET_CRESCENDO_BS
    case "testnet":
        address_prefix = "karlsentest"
        address_example = "karlsentest:qpqz2vxj23kvh0m73ta2jjn2u4cv4tlufqns2eap8mxyyt0rvrxy6ejkful67"
        max_supply = DEFAULT_MAX_SUPPLY_KLS
        crescendo_bs = DEFAULT_CRESCENDO_BS
    case "simnet":
        address_prefix = "karlsensim"
        address_example = "karlsensim:qpqz2vxj23kvh0m73ta2jjn2u4cv4tlufqns2eap8mxyyt0rvrxy6ejkful67"
        max_supply = DEFAULT_MAX_SUPPLY_KLS
        crescendo_bs = DEFAULT_CRESCENDO_BS
    case "devnet":
        address_prefix = "karlsendev"
        address_example = "karlsendev:qpqz2vxj23kvh0m73ta2jjn2u4cv4tlufqns2eap8mxyyt0rvrxy6ejkful67"
        max_supply = DEFAULT_MAX_SUPPLY_KLS
        crescendo_bs = DEFAULT_CRESCENDO_BS
    case _:
...
MAX_SUPPLY_KLS = max_supply
CRESCENDO_BS = crescendo_bs
REGEX_KARLSEN_ADDRESS = "^" + ADDRESS_PREFIX + ":[a-z0-9]{61,63}$"
