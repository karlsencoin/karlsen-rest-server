...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["Karlsen network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["Karlsen network info"])
@sql_db_only
